...
times_df, montaj_df, cmy_df = arrange_df(df = times_df, relevant_col_idx = [3, 25, 29, 30], df_type = "times")
...
sequence_matrix = gross_seq_matrix(df = merged_df, lookup_col = "station", matrix_type = "station")
time_matrix = gross_seq_matrix(df = merged_df, lookup_col = "cycle_times", matrix_type = "time")